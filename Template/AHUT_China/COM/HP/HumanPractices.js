...
export default {
    ...
    template: `
    <writing-container>
        <h1 class="pt-2">Human Practices</h1>
        <hr/>
        
        <h2>1.\tThe Interview at Yushan Lake Park</h2>
        <img class="img-fluid p-4" alt="Human_Practices_01" src="/Team/AHUT_China/imgs/HumanPractices_01.jpg">
        <img class="img-fluid p-4" alt="Human_Practices_02" src="/Team/AHUT_China/imgs/HumanPractices_02.jpg">
        <p>As the number of deaths from malignant tumors continues to rise, our research into the development of malignant tumors in the elderly focuses on the differences between existing treatments and our products. We endeavor to extract substances from mulberry leaves that effectively kill tumor cells to replace the expensive targeted drugs.</p>
        <p>In July 2021, we conducted interviews at Yushan Lake Park, Ma'anshan City, to determine how much the public knows about malignant tumors, tumor treatment, and tumor therapeutic drugs. Through the investigation, we found that the public does not fully understand malignant tumors and their treatment, and there are many misunderstandings. For example, some people have partial faith or dependence on certain health products. In addition, some people fear that the more nutritious food they eat, the faster tumor cells grow. Furthermore, some people believe that tumors can be cured entirely after resection. Moreover, families that cannot afford treatments give up treating, believing that a tumor equals a terminal illness.</p>
        ...
        <img class="img-fluid p-4" alt="Human_Practices_03" src="/Team/AHUT_China/imgs/HumanPractices_03.jpg">
        <img class="img-fluid p-4" alt="Human_Practices_04" src="/Team/AHUT_China/imgs/HumanPractices_04.jpg">
        ...
        <img class="img-fluid p-4" alt="Human_Practices_05" src="/Team/AHUT_China/imgs/HumanPractices_05.jpg">
        <img class="img-fluid p-4" alt="Human_Practices_06" src="/Team/AHUT_China/imgs/HumanPractices_06.png">
        ...
        <p>AHUT_China upgraded its WeChat public account (Instagram and Twitter account) in 2021. During the implementation of the project this year, more than X original articles have been published since the establishment of the team. This year , we actively carry out social practice through such an external publicity platf1orm to promote the iGEM contest and introduce our project.</p>
        ...
        <p>The Project Progress module includes the promotion team, the experiment process, and the Logo display. Our articles are regularly reported and updated weekly. In addition, the team holds regular meetings, from the 2021-X-X weekly report to 2021-X-X.</p>
        ...
        <img class="img-fluid p-4" alt="Human_Practices_07" src="/Team/AHUT_China/imgs/HumanPractices_07.jpg">
        ...
        <img class="img-fluid p-4" alt="Human_Practices_08" src="/Team/AHUT_China/imgs/HumanPractices_08.jpg">
        <img class="img-fluid p-4" alt="Human_Practices_09" src="/Team/AHUT_China/imgs/HumanPractices_09.jpg">
        <img class="img-fluid p-4" alt="Human_Practices_10" src="/Team/AHUT_China/imgs/HumanPractices_10.jpg">
        <img class="img-fluid p-4" alt="Human_Practices_11" src="/Team/AHUT_China/imgs/HumanPractices_11.jpg">

        <h2>8. Interview with Dr. XXX</h2>
        <p>Many problems were encountered during the experiment.</p>
        ...
        <img class="img-fluid p-4" alt="Human_Practices_12" src="/Team/AHUT_China/imgs/HumanPractices_12.jpg">
        <img class="img-fluid p-4" alt="Human_Practices_13" src="/Team/AHUT_China/imgs/HumanPractices_13.jpg">
        <img class="img-fluid p-4" alt="Human_Practices_14" src="/Team/AHUT_China/imgs/HumanPractices_14.jpg">
        <img class="img-fluid p-4" alt="Human_Practices_15" src="/Team/AHUT_China/imgs/HumanPractices_15.jpg">
