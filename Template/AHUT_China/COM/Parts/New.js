...
export default {
    ...
    <writing-container>
        ...
        <img-fluid alt="NewParts_02" src="/resources/images/parts/NewParts_02.jpg" caption="Fig. 2 Positive colonies harboring Her2-ISZ-sTRAIL expression plasmids grown on the plate with kanamycin"></img-fluid>
        ...
        <img-fluid alt="NewParts_03" src="/resources/images/parts/NewParts_03.jpg" caption="Fig. 3 SDS-PAGE analysis of induced Her2-ISZ-sTRAIL expression in E. coli BL21(DE3)"></img-fluid> 
        ...
        <img-fluid alt="NewParts_04" src="/resources/images/parts/NewParts_04.png" caption="Fig. 4 Her2-ISZ-sTRAIL protein was purified by Ni column and different fractions were analyzed by SDS-PAGE. Lane M: Protein marker; Lane 1: cell lysates without IPTG induction; Lane 2: cell lysates with IPTG induction; Lane 3: purified Her2-ISZ-sTRAIL protein."></img-fluid>
        <img-fluid alt="NewParts_05" src="/resources/images/parts/NewParts_05.jpg" caption="Fig. 5 Western blot analysis of purified Her2-ISZ-sTRAIL protein."></img-fluid>
        ...
        <img-fluid alt="NewParts_08" src="/resources/images/parts/NewParts_08.png" caption="Fig. 8 Map of Vgb-pelB-Her2-ISZ-sTRAIL recombinant vector"></img-fluid>
        <img-fluid alt="NewParts_09" src="/resources/images/parts/NewParts_09.png" caption="Fig. 9 Agarose gel electrophoresis of Vgb-pelB-Her2-ISZ-sTRAIL recombinant plasmid. M: DNA Marker; 1: pET-28a- Vgb-pelB-Her2-ISZ-sTRAIL; 2.pET-28a(+)"></img-fluid>
        ...
        <img-fluid alt="NewParts_10" src="/resources/images/parts/NewParts_10.jpg" caption="Fig. 10 Results of electroporation of Vgb-pelB-Her2-ISZ-sTRAIL plasmid (1) and pET-28a (+) plasmid (2) into EcN 1917"></img-fluid>
