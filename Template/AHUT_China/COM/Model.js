...
export default {
    ...
    <writing-container>
        ...
        <img-caption>Fig.1 Distribution of cancer cells in patients over </img-caption>
        <img-fluid alt="Model_02" src="/resources/images/Model_02.jpg"></img-fluid>
        <img-caption>Fig.2 two dimensional distribution of cancer cells over time</img-caption>
        ...
        <img-caption>Fig.3 distribution of Escherichia coli in patients over time</img-caption> 
        <img-fluid alt="Model_04" src="/resources/images/Model_04.jpg"></img-fluid>
        <img-caption>Fig.4 two dimensional distribution of Escherichia coli over time</img-caption>
        ...
        <img-caption>Fig.5 experimental diagram of trail cytotoxicity</img-caption>
        ...
        <img-caption>Fig.6 changes of cell inhibition rate.</img-caption>
        <img-fluid alt="Model_07" src="/resources/images/Model_07.png"></img-fluid>
        <img-caption>Fig.7 changes of cell inhibition rate.</img-caption>
        ...
        <br/>
        <h1>Reference</h1>
        <p>[1]\tTANG Sitian.The Research on two types of virus infection model with humoral imminity【D】,Xinjiang University  ,2019,undefined</p>
        <p>[2]\tTuring Instability and Turing–Hopf Bifurcation in Diffusive Schnakenberg Systems with Gene Expression Time Delay[J] . Weihua Jiang,Hongbin Wang,Xun Cao.  Journal of Dynamics and Differential Equations . 2019 (4)</p>
        <p>[3]\tWEI X，CUI S． Existence and uniqueness of global solu- tions for a mathematical model of antiangiogenesis in tumor growth ［J］． Nonlinear Analysis: Real World Ap- plications，2008，9: 1827 － 1836．</p>
        <p>[4]\tZHANG Jiuyuan.etc (2013) Analysis of a mathematical modeling of cancer cell breakout and invasion of normal tissue or extracellular matrix, Zhongshan Daxue Xuebao/Acta Scientiarum Natralium Universitatis Sunyatseni,52(3), 48–54. doi: 10.13471/j.cnki.acta.snus.2013.03.008.</p>   
        <p>[5]\tCompetition of Spatial and Temporal Instabilities under Time Delay near Codimension-Two Turing—Hopf Bifurcations[J] . Wang Hui-Juan,Ren Zhi.  Communications in Theoretical Physics . 2011 (2)</p> 
        <p>[6]\tANDASARI V，GERISCH A，LOLAS G，et al． Mathe- matical modeling of cancer cell invasion of tissue: biologi- cal insight from mathematical analysis and computational simulation ［J］． Math Biol，2011，23: 141 － 171．</p> 
        <p>[7]\tCHAPLAIN M A J，LOLAS G． Mathematical modeling of cancer invasion of tissue: the role of the urokinase plas- minogen activation system ［J］． Math Mod Meth in Appl Sci，2005，11: 1685 － 1734．</p>
        <p>[8]\tCUI S． Analysis of a free boundary problem modeling tumor growth ［J］． Acta Math Appl Sin Engl Ser，2005， 21: 1071 － 1082．</p>
    </writing-container>
    `,
    updated() {
