...
export default {
    ...
    <writing-container>
        ...
        <p>Then, we designed the primers for PCR amplification of ISZ-sTRAIL gene fragments, and obtained the ISZ-sTRAIL gene (666bp) via PCR using pET28a-his-linker-her2-linker-ISZ-sTRAIL(BBa_K3981015) as the template (Fig. 3).</p> 
        ...
        <p>Based on the ISZ-sTRAIL expression vectors, a sequence of Her2-affibody, which could increase the target effect of ISZ-sTRAIL, was added to the N-terminus of ISZ-sTRAIL plasmid to construct a new part of pET-28a(+)-His-linker-Her2-ISZ-sTRAIL (BBa_K3981015, Her2- ISZ-sTRAIL for short) recombinant vector.</p> 
