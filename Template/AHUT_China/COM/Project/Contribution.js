...
export default {
    ...
    <writing-container>
        <h1>Contribution</h1>
        <hr/>
        <p>We validated an existing part of the hypoxia-inducible promoter vgb (<partinfo name="K561001"></partinfo>) and added the results to the corresponding BioBricks. All of this may help other teams. We hope it will make a contribution to the IGEM community.</p>
        <hr/>

        <p>Based on the sequence of <partinfo name="K561001"></partinfo>, we demonstrated the function of vgb promoter to express the target protein in E. coli low oxygen conditions, and the results were showed as follows: </p> 
